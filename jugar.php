...
switch ($_POST['submit']){
    ...
    case "jugar":
        ...
        $jugada=filter_input(INPUT_POST, "jugadas");
        $jugada++;
        if ($jugada>$intentos){
            header("Location:fin.php?jugadas=$jugada");
        }
    ...
    case "reiniciar":
        ...
        $num =$max/2;
        $jugada =1;
        $resto_intentos = $intentos;
        echo "<h1>Reiniciando intentos a $resto_intentos</h1>";
        break;
    case "volver":
        header("Location:index.php");
        break;
...
<fieldset style="width:40%;background:bisque ">
    ...
    <form action="jugar.php" method="POST" >
        ...
        <input type="hidden" value="<?= $jugada ?>" name="jugadas">
        <fieldset>
